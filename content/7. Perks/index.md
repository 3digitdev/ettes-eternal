...
- [[Knowledge Skill Perks|Knowledge Skill Perks]]
- [[Mental Skill Perks|Mental Skill Perks]]
- [[Physical Skill Perks|Physical Skill Perks]]
- [[Social Skill Perks|Social Skill Perks]]
- [[Technical Skill Perks|Technical Skill Perks]]
# Tier System
Perks are organized into **four tiers** that reflect their power level and complexity. Higher-tier perks provide more significant benefits but require greater character advancement to access, and often will require earlier-Tier Perks before they can be taken.  Perks are, like many other systems, based on the Apprentice → Legendary [[1. Basics/index#Tiered Systems|Tier System]].

Ettes Eternal endeavors to keep "prerequisite chains" as simple as possible, rather than complex dependency trees.
## Stacking Perks
Some perks have a table showing a "stacking" effect, or will describe one.  The [[3. Classes/index#Multiclassing|Multiclassing]] perks are both "stacking".  Another good example is [[Combat Perks#Last Stand|Last Stand]]:  Each time you take this Perk, you gain an additional effect (up to 5 effects).  **You must take these Perks multiple times to gain the increasing effects**.
## Tiered Perks
