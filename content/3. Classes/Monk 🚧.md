...
### Storm Body
- You gain the **Lightning Strike** Flow Action (_see below_)
...
**Cost:**  2 AP **OR** 5 FP
**Effect:** Make a Recovery Roll immediately. Additionally, remove one negative status effect currently affecting you (including persistent damage).  Can be used while Asleep and Paralyzed, unlike most abilities.  This cannot be used to remove the Prone effect.