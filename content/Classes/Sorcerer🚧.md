...
**Effect:** You may use your Spellcasting skill instead of any other skill to help you [[Basic Mechanics#Aid Another|Aid Another]] in a Skill Check.. You must describe how you're using magic to accomplish the task. This does not need to replicate an effect one of your spells provides.  Just like Aid Another, **this cannot be used with Combat Skills.**
...
_Examples:_
- _Channel a touch spell through your dagger - deliver the spell effect when you hit with a melee attack instead of needing a separate touch_
- _Channel a spell through a thrown rock - the spell activates when the object hits the target_
- _Channel an area effect spell through an object you place - the spell emanates from that object's location instead of from you_
- _Channel a protective spell through your cloak - the spell activates automatically when you're attacked_
- _Channel a spell through a piece of jewelry - the spell activates when someone touches the pendant or ring_
- _Channel a spell through a mirror to hit around corners, bypassing line of sight requirements_
...
_GM Note: These consequences should be significant and interesting, not trivial. They should have some negative aspects but not be entirely negative - think "dramatic complications that create new opportunities and challenges" rather than simple punishments._