...
**Prerequisite:** You must not be last in initiative order among your party members.
**Cost:**  1 FP (you start the combat with only 1 FP instead of 2)
...
- **Social Challenges:** When entering a new [[Social Challenges|Social Challenge]], you gain Advantage on your first Insight check to assess the social dynamics and participants.
### Castle
Swap positions with any willing ally within range based on your Fighter Class Tier. Both movements provoke Reaction Attacks, but you may spend 1 RP during this movement to use **Intercept** (Advanced Reaction) against any Reaction Attack targeting your ally.
...
- **Social Challenges:** Once per [[Social Challenges|Social Challenge]], reduce the FP cost of an ally's social Flow Action by 1 (minimum 1).
...
_**NOTE:** If you have the [[Combat Perks#Quick Draw|Quick Draw]] Perk, all draw/sheathe/weapon changes become free actions (0 AP)_
...
| Level | Feature       | Description                                          |
| ----- | ------------- | ---------------------------------------------------- |
| 5     | Glancing Blow | DR on failed (not crit failed) blocks by shield size |
| 6     | Provoke       | Force enemy to target you (6 hex range)              |
| 7     | Shield Wall   | Grant DR to adjacent allies by shield size           |
### Glancing Blow
When you fail (but not critically fail) on a Block Reaction, you absorb some of the attack's impact on the shield and gain DR against that attack:
- **Small Shield:** +1 DR
- **Large Shield:** +2 DR
- **Tower Shield:** +4 DR
### Provoke
**Cost:** 2 AP  
Force an enemy within 6 hexes to make a Willpower save. On failure, they must target you with their next attack.
### Shield Wall
When adjacent to an ally, both you and the ally gain DR based on your shield:
- **Small Shield:** +1 DR
- **Large Shield:** +2 DR
- **Tower Shield:** +3 DR