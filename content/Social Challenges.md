...
| -------------- | --------------------------------------------------- | ------------------------------- |
| **Controlled** | Achieve effect, no complications                    | No progress, no complications   |
| **Risky**      | Achieve effect, potentially gain minor complication | No progress, minor complication |
| **Desperate**  | Achieve effect, immediate complication              | No progress, major consequence  |
