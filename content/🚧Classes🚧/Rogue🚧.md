...
- Attacking in the same turn after a successful Feint
...
|6|Vital Strike|Sneak Attack uses d8s instead of d6s|
...
### Vital Strike
Your Sneak Attack dice become d8s instead of d6s.
### Phase Step
